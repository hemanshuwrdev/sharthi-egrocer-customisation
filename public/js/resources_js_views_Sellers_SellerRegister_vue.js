...
/* harmony import */ var _firebase_logger__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @firebase/logger */ "./node_modules/@firebase/logger/dist/esm/index.esm.js");
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @firebase/component */ "./node_modules/@firebase/component/dist/esm/index.esm.js");
        ...
        return new Promise((resolve, reject) => {
            retrieveSiteKey(this.auth)
                ...
                if (!forceRefresh &&
                    ...
                    RecaptchaEnterpriseVerifier.scriptInjectionDeferred =
                        new _firebase_util__WEBPACK_IMPORTED_MODULE_1__.Deferred();
                    /**
...
/* harmony import */ var _firebase_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @firebase/component */ "./node_modules/@firebase/component/dist/esm/index.esm.js");
...
/* harmony import */ var _firebasePhoneAuth__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../firebasePhoneAuth */ "./resources/js/firebasePhoneAuth.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getCountries: function getCountries() {
      var _this6 = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$sellerApiUrl + '/register/countries', {
        params: {
          limit: 250
        }
...
/***/ "./resources/js/firebasePhoneAuth.js":
/*!*******************************************!*\
  !*** ./resources/js/firebasePhoneAuth.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   confirmFirebaseOtp: () => (/* binding */ confirmFirebaseOtp),
/* harmony export */   sendFirebaseOtp: () => (/* binding */ sendFirebaseOtp)
/* harmony export */ });
...
function fetchConfig(apiUrl) {
  if (!configPromise) {
    configPromise = axios__WEBPACK_IMPORTED_MODULE_3___default().get(apiUrl + '/firebase/public_config').then(function (res) {
      return res.data.data;
    });
  }
  return configPromise;
}
function getFirebaseAuth(_x) {
  return _getFirebaseAuth.apply(this, arguments);
}
/**
...
function _getFirebaseAuth() {
  _getFirebaseAuth = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(apiUrl) {
    var config, app;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", authInstance);
          case 2:
            _context.next = 4;
            return fetchConfig(apiUrl);
          case 4:
            config = _context.sent;
            app = (0,firebase_app__WEBPACK_IMPORTED_MODULE_1__.getApps)().length ? (0,firebase_app__WEBPACK_IMPORTED_MODULE_1__.getApp)() : (0,firebase_app__WEBPACK_IMPORTED_MODULE_1__.initializeApp)({
            ...
            authInstance = (0,firebase_auth__WEBPACK_IMPORTED_MODULE_2__.getAuth)(app);
            return _context.abrupt("return", authInstance);
          case 8:
          case "end":
...
function resetRecaptcha(recaptchaContainerId) {
  ...
  var container = document.getElementById(recaptchaContainerId);
  if (container) container.innerHTML = '';
}
function sendFirebaseOtp(_x2, _x3, _x4) {
  return _sendFirebaseOtp.apply(this, arguments);
}
function _sendFirebaseOtp() {
  _sendFirebaseOtp = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(apiUrl, recaptchaContainerId, phoneNumber) {
    var auth;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return getFirebaseAuth(apiUrl);
          case 2:
            auth = _context2.sent;
            resetRecaptcha(recaptchaContainerId);
            recaptchaVerifiers[recaptchaContainerId] = new firebase_auth__WEBPACK_IMPORTED_MODULE_2__.RecaptchaVerifier(auth, recaptchaContainerId, {
              size: 'invisible'
            });
            _context2.prev = 5;
            _context2.next = 8;
            return (0,firebase_auth__WEBPACK_IMPORTED_MODULE_2__.signInWithPhoneNumber)(auth, phoneNumber, recaptchaVerifiers[recaptchaContainerId]);
          case 8:
...
function confirmFirebaseOtp(confirmationResult, code) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n#auth[data-v-e3df3948] {\n    overflow: auto !important;\n}\n.input-group.mobile-input-group[data-v-e3df3948] {\n    flex-wrap: nowrap;\n    border: 1px solid #ced4da;\n    border-radius: 0.375rem;\n    background: #fff;\n}\n.mobile-input-group .country-code-toggle[data-v-e3df3948] {\n    border-top-left-radius: 0.375rem;\n    border-bottom-left-radius: 0.375rem;\n}\n.mobile-input-group > *[data-v-e3df3948]:last-child {\n    border-top-right-radius: 0.375rem;\n    border-bottom-right-radius: 0.375rem;\n}\n.mobile-input-group .country-code-dropdown[data-v-e3df3948] {\n    position: relative;\n    flex: 0 0 auto;\n    width: 72px;\n    border-right: 1px solid #ced4da;\n}\n.mobile-input-group .country-code-toggle[data-v-e3df3948] {\n    width: 100%;\n    height: 100%;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n    gap: 2px;\n    padding: 0.375rem 0.5rem;\n    border: none;\n    background: transparent;\n    cursor: pointer;\n}\n.mobile-input-group input.form-control[data-v-e3df3948] {\n    flex: 1 1 auto;\n    min-width: 0;\n    border: none;\n    border-radius: 0;\n    box-shadow: none;\n}\n.mobile-input-group input.form-control[data-v-e3df3948]:focus {\n    box-shadow: none;\n}\n.country-code-caret[data-v-e3df3948] {\n    width: 0;\n    height: 0;\n    border-left: 4px solid transparent;\n    border-right: 4px solid transparent;\n    border-top: 5px solid #6c757d;\n}\n.mobile-input-group .send-otp-btn[data-v-e3df3948] {\n    flex: 0 0 auto;\n    white-space: nowrap;\n    margin: -1px -1px -1px 0;\n    border-top-left-radius: 0;\n    border-bottom-left-radius: 0;\n}\n.country-code-menu[data-v-e3df3948] {\n    position: absolute;\n    top: 100%;\n    left: 0;\n    z-index: 1050;\n    width: 100%;\n    max-height: 220px;\n    overflow-y: auto;\n    margin: 2px 0 0;\n    padding: 4px 0;\n    list-style: none;\n    background: #fff;\n    border: 1px solid #ced4da;\n    border-radius: 4px;\n    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);\n}\n.country-code-menu li[data-v-e3df3948] {\n    padding: 6px 12px;\n    cursor: pointer;\n}\n.country-code-menu li[data-v-e3df3948]:hover {\n    background: #f1f3f5;\n}\n.auth[data-v-e3df3948] {\n    overflow-x: hidden !important;\n}\n.auth-logo[data-v-e3df3948] {\n    padding-bottom: 10px;\n}\n.auth .login-wrapper[data-v-e3df3948] {\n    justify-content: center;\n    align-items: center;\n    padding: 30px 20px;\n}\n.auth .detail-card[data-v-e3df3948] {\n    max-width: 95%;\n    width: 100%;\n    max-width: 1100px;\n    margin: 0 auto;\n}\n.auth .content[data-v-e3df3948] {\n    max-height: 70vh;\n    overflow-y: auto;\n}\n", ""]);
// Exports
                  ...
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "row" }, [
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c(
                                    ...
                                    [
                                      _c("span", [
                                        _vm._v(_vm._s(_vm.country_code)),
                                      ]),
                                      _vm._v(" "),
                                      _c("span", {
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "btn btn-outline-success send-otp-btn",
                                  attrs: {
                                    type: "button",
                                    disabled:
                                      _vm.otp_sending ||
                      ...
                      _vm.otp_sent
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _c("div", { attrs: { id: "seller-register-recaptcha" } }),
                      _vm._v(" "),
                      _c("div", { staticClass: "form-group col-md-4" }, [
                        _c("div", { staticClass: "form-group" }, [
                          _c("label", [
                      ...
                      _c(
                        "div",
                        { staticClass: "form-group col-md-4 categories-field" },
                        [
                          _c(
                            "div",
...
/* harmony export */ });
/* harmony import */ var _firebase_auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @firebase/auth */ "./node_modules/@firebase/auth/dist/esm/index.js");
