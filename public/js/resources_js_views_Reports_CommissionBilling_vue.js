  ...
  methods: {
    loadSummary: function loadSummary() {
      ...
      axios.get(this.$apiUrl + '/commissions/summary').then(function (res) {
        _this.summaryData = res.data.data.data || [];
        _this.sellers = _this.summaryData;
        _this.summaryLoading = false;
      })["catch"](function () {
        _this.summaryLoading = false;
      });
    },
    openDistributor: function openDistributor(item) {
      this.detailSeller = item;
      this.detailPage = 1;
      this.loadDetail(item.seller_id, 1);
    },
    loadDetail: function loadDetail(sellerId) {
      var _this2 = this;
  ...
  return _c("div", [
    _c("div", { staticClass: "page-heading" }, [
      ...
      _c("section", { staticClass: "section" }, [
        _c(
          "ul",
          { staticClass: "nav nav-tabs mb-3", attrs: { id: "commissionTabs" } },
          [
                    ...
                    _c(
                      ...
                      [
                        _c("h4", { staticClass: "card-title mb-0" }, [
                          _vm._v(
                            "\n                            " +
                              _vm._s(_vm.detailSeller.name) +
                              " — " +
                              _vm._s(_vm.__("detail")) +
                              "\n                            "
                          ),
                          _c(
                            "span",
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.detailSeller.commission_rate) +
                                  "% " +
                        ...
                        ? _c(
                            ...
                            [
                              _c(
                                "b-row",
                                { staticClass: "mb-3" },
                                _vm._l(_vm.gmvKeys, function (label, key) {
                                  return _c(
                                    "b-col",
                                    { key: key, attrs: { md: "2" } },
                                    [
                                      _c(
                                        ...
                                        {
                                          staticClass:
                                            "card text-center border-0 shadow-sm p-2",
                                        },
                                        [
                                          _c(
                                            "div",
                                            ...
                                            [
                                              _vm._v(
                                                _vm._s(_vm.__("commission")) +
                                                  ...
                                                  " " +
                                                  _vm._s(
                                                    _vm.detailData.commission_earned[
                                                      key
                                                    ].toFixed(2)
                                                  )
                                              ),
                              ...
                              _c(
                                ...
                                [
                                  _c("b-table", {
                                    attrs: {
                                      items: _vm.detailData.transactions.data,
                                      fields: _vm.txFields,
                                      bordered: true,
                                      "show-empty": "",
                                      small: "",
                              ...
                              _c("b-pagination", {
                                ...
                                attrs: {
                                  "total-rows":
                                    _vm.detailData.transactions.total,
