(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_Reports_CommissionBilling_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=script&lang=js":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=script&lang=js ***!
  \**************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      summaryFields: [{
        ...
        key: 'commission_rate',
        label: __('commission_rate'),
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'gmv_this_month',
        label: __('gmv_this_month'),
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'commission_this_month',
        label: __('commission_this_month'),
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'gmv_all_time',
        label: __('gmv_all_time'),
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'commission_all_time',
        label: __('commission_all_time'),
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'actions',
  ...
  computed: {
    totalGmvMonth: function totalGmvMonth() {
      return this.summaryData.reduce(function (s, r) {
        return s + r.gmv_this_month;
      }, 0);
    },
    totalCommMonth: function totalCommMonth() {
      return this.summaryData.reduce(function (s, r) {
        return s + r.commission_this_month;
      }, 0);
    },
    totalTxCommission: function totalTxCommission() {
      return this.txData.reduce(function (s, r) {
        return s + parseFloat(r.commission_amount || 0);
      }, 0);
    }
  },
  ...
  methods: {
    ...
    loadAggregate: function loadAggregate() {
      var _this = this;
      ...
      axios.get(this.$apiUrl + '/commissions/aggregate', {
        ...
        if (res.data && res.data.data) {
          _this.agg = res.data.data;
        }
        _this.aggLoading = false;
      })["catch"](function () {
        _this.aggLoading = false;
      });
    },
    loadSummary: function loadSummary() {
      ...
      axios.get(this.$apiUrl + '/commissions/summary').then(function (res) {
        _this2.summaryData = res.data.data.data || [];
        _this2.sellers = _this2.summaryData;
        _this2.summaryLoading = false;
      })["catch"](function () {
        _this2.summaryLoading = false;
      });
    },
    loadTransactions: function loadTransactions() {
      ...
      this.txLoading = true;
      this.txPage = page;
      var offset = (page - 1) * this.txPerPage;
      axios.get(this.$apiUrl + '/commissions', {
        params: {
          seller_id: this.txSeller || undefined,
          start_date: this.txDateRange.startDate ? moment__WEBPACK_IMPORTED_MODULE_2___default()(this.txDateRange.startDate).format('YYYY-MM-DD') : undefined,
          end_date: this.txDateRange.endDate ? moment__WEBPACK_IMPORTED_MODULE_2___default()(this.txDateRange.endDate).format('YYYY-MM-DD') : undefined,
          limit: this.txPerPage,
          offset: offset
        }
      }).then(function (res) {
        _this3.txData = res.data.data.data || [];
        _this3.txTotal = res.data.data.total || 0;
        _this3.txLoading = false;
      })["catch"](function () {
        _this3.txLoading = false;
      });
    },
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n/* ── Stat cards ────────────────────────────────────────────────── */\n.stat-card[data-v-07d12291] {\n    display: flex;\n    align-items: flex-start;\n    gap: 16px;\n    background: #fff;\n    border-radius: 14px;\n    padding: 22px 20px;\n    box-shadow: 0 2px 12px rgba(0, 0, 0, 0.07);\n    border: 1px solid #f0f0f0;\n    height: 100%;\n    transition: box-shadow 0.2s;\n}\n.stat-card[data-v-07d12291]:hover {\n    box-shadow: 0 6px 24px rgba(0, 0, 0, 0.11);\n}\n.stat-card__icon-wrap[data-v-07d12291] {\n    flex-shrink: 0;\n    width: 52px;\n    height: 52px;\n    border-radius: 50%;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: 20px;\n}\n.stat-card__icon-wrap--green[data-v-07d12291] { background: #e8f8f1; color: #22c55e;\n}\n.stat-card__icon-wrap--blue[data-v-07d12291]  { background: #e8f0fe; color: #4f8ef7;\n}\n.stat-card__body[data-v-07d12291] { flex: 1; min-width: 0;\n}\n.stat-card__label[data-v-07d12291] {\n    font-size: 11px;\n    font-weight: 700;\n    letter-spacing: 0.08em;\n    text-transform: uppercase;\n    color: #9ca3af;\n    margin-bottom: 4px;\n}\n.stat-card__value[data-v-07d12291] {\n    font-size: 28px;\n    font-weight: 800;\n    color: #111827;\n    line-height: 1.1;\n    margin-bottom: 8px;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n}\n.stat-card__value--blue[data-v-07d12291] { color: #4f8ef7;\n}\n.stat-card__meta[data-v-07d12291] {\n    display: flex;\n    align-items: center;\n    gap: 8px;\n    margin-bottom: 2px;\n}\n.stat-card__badge[data-v-07d12291] {\n    display: inline-flex;\n    align-items: center;\n    gap: 4px;\n    font-size: 12px;\n    font-weight: 700;\n    padding: 2px 9px;\n    border-radius: 20px;\n}\n.stat-card__badge--up[data-v-07d12291]      { background: #dcfce7; color: #16a34a;\n}\n.stat-card__badge--down[data-v-07d12291]    { background: #fee2e2; color: #dc2626;\n}\n.stat-card__badge--neutral[data-v-07d12291] { background: #eff6ff; color: #3b82f6;\n}\n.stat-card__sub[data-v-07d12291] { font-size: 11px; color: #b0b7c3;\n}\n.stat-card__divider[data-v-07d12291] { border-top: 1px solid #f3f4f6; margin: 12px 0;\n}\n.stat-card__row[data-v-07d12291] { display: flex; gap: 24px;\n}\n.stat-card__row-item[data-v-07d12291] { flex: 1; min-width: 0;\n}\n.stat-card__row-label[data-v-07d12291] { font-size: 11px; color: #9ca3af; margin-bottom: 2px; white-space: nowrap;\n}\n.stat-card__row-value[data-v-07d12291] {\n    font-size: 14px;\n    font-weight: 600;\n    color: #374151;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis;\n}\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CommissionBilling_vue_vue_type_style_index_0_id_07d12291_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CommissionBilling_vue_vue_type_style_index_0_id_07d12291_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/views/Reports/CommissionBilling.vue":
/*!**********************************************************!*\
  !*** ./resources/js/views/Reports/CommissionBilling.vue ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CommissionBilling_vue_vue_type_template_id_07d12291_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true */ "./resources/js/views/Reports/CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true");
/* harmony import */ var _CommissionBilling_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CommissionBilling.vue?vue&type=script&lang=js */ "./resources/js/views/Reports/CommissionBilling.vue?vue&type=script&lang=js");
/* harmony import */ var _CommissionBilling_vue_vue_type_style_index_0_id_07d12291_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css */ "./resources/js/views/Reports/CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _CommissionBilling_vue_vue_type_template_id_07d12291_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _CommissionBilling_vue_vue_type_template_id_07d12291_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "07d12291",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/Reports/CommissionBilling.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/views/Reports/CommissionBilling.vue?vue&type=script&lang=js":
/*!**********************************************************************************!*\
  !*** ./resources/js/views/Reports/CommissionBilling.vue?vue&type=script&lang=js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/Reports/CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css":
/*!******************************************************************************************************************!*\
  !*** ./resources/js/views/Reports/CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css ***!
  \******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_CommissionBilling_vue_vue_type_style_index_0_id_07d12291_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=style&index=0&id=07d12291&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/views/Reports/CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true":
/*!****************************************************************************************************!*\
  !*** ./resources/js/views/Reports/CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CommissionBilling_vue_vue_type_template_id_07d12291_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CommissionBilling_vue_vue_type_template_id_07d12291_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CommissionBilling_vue_vue_type_template_id_07d12291_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Reports/CommissionBilling.vue?vue&type=template&id=07d12291&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                      ...
                      _c("div", { staticClass: "stat-card stat-card--gmv" }, [
                        ...
                        _c("div", { staticClass: "stat-card__body" }, [
                          ...
                          _c("div", { staticClass: "stat-card__value" }, [
                            _vm._v(
                              "\n                                " +
                                ...
                                " " +
                                _vm._s(
                                  _vm.formatAmount(_vm.agg.gmv_card.current)
                                ) +
                                "\n                            "
                            ),
                          ]),
                          ...
                          _c("div", { staticClass: "stat-card__meta" }, [
                            _vm.agg.gmv_card.change_percent !== null
                              ? _c(
                                  "span",
                                  {
                                    staticClass: "stat-card__badge",
                                    class:
                                      _vm.agg.gmv_card.change_percent >= 0
                                        ? "stat-card__badge--up"
                                  ...
                                  [
                                    ...
                                    _vm._v(
                                      "\n                                    " +
                                        _vm._s(
                                          Math.abs(
                                            _vm.agg.gmv_card.change_percent
                                          )
                                        ) +
                                        "%\n                                "
                                    ),
                          ...
                          _c("div", { staticClass: "stat-card__row" }, [
                            ...
                            _c("div", { staticClass: "stat-card__row-item" }, [
                              ...
                              _c(
                                "div",
                                {
                                  staticClass: "stat-card__row-value text-info",
                                },
                                [
                                  _vm._v(
                                    _vm._s(_vm.$currency) +
                                      ...
                                      _vm._s(
                                        _vm.formatAmount(
                                          _vm.agg.gmv_card.predicted_next
                                        )
                                      )
                                  ),
                                ]
                  ...
                  _c("b-col", { attrs: { md: "6" } }, [
                    _c("div", { staticClass: "stat-card stat-card--fees" }, [
                      ...
                      _c("div", { staticClass: "stat-card__body" }, [
                          ...
                          [
                            _vm._v(
                              "\n                                " +
                                ...
                                " " +
                                _vm._s(
                                  _vm.formatAmount(_vm.agg.charges_card.current)
                                ) +
                                "\n                            "
                            ),
                          ]
                        ...
                        _c("div", { staticClass: "stat-card__meta" }, [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(
                                "\n                                    " +
                                  _vm._s(_vm.agg.charges_card.total_orders) +
                                  " " +
                        ...
                        _c("div", { staticClass: "stat-card__row" }, [
                          _c("div", { staticClass: "stat-card__row-item" }, [
                            _c("div", { staticClass: "stat-card__row-label" }, [
                              _vm._v(_vm._s(_vm.__("total_distributors"))),
                            ]),
                            _vm._v(" "),
                            _c(
                              "div",
                              { staticClass: "stat-card__row-value fw-bold" },
                              [_vm._v(_vm._s(_vm.summaryData.length))]
                            ),
                          ]),
                          _vm._v(" "),
                          _c("div", { staticClass: "stat-card__row-item" }, [
                            ...
                            _vm._v(" "),
                            _c("div", { staticClass: "stat-card__row-value" }, [
                              _vm._v(
                                "\n                                        " +
                                  _vm._s(_vm.$currency) +
                                  " " +
                                  _vm._s(
                                    _vm.agg.charges_card.total_orders > 0
                                      ? _vm.formatAmount(
                                          _vm.agg.charges_card.current /
                                            _vm.agg.charges_card.total_orders
                                        )
                                      : "0.00"
                                  ) +
                                  "\n                                    "
              ...
              _c("li", { staticClass: "nav-item" }, [
                _c(
                  "a",
                  {
                    ...
                    class: { active: _vm.activeTab === "summary" },
                    attrs: { href: "#" },
                    on: {
                      click: function ($event) {
                  ...
                  [
                    _vm._v(
                      "\n                        " +
                        _vm._s(_vm.__("distributor_summary")) +
                        "\n                    "
                    ),
                  ]
                ),
              ...
              _c("li", { staticClass: "nav-item" }, [
                _c(
                  ...
                  [
                    _vm._v(
                      "\n                        " +
                        _vm._s(_vm.__("all_transactions")) +
                        "\n                    "
                    ),
                  ]
                ),
