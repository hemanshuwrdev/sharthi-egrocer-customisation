      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$apiUrl + "/contact_us").then(function (res) {
        ...
        try {
          ...
          _this2.languages.forEach(function (lang) {
            if (parsed[lang.code]) {
              _this2.translations[lang.id].contact_us = parsed[lang.code];
            }
          });
        } catch (_unused) {
          if (_this2.defaultLanguageId) {
            _this2.translations[_this2.defaultLanguageId].contact_us = _this2.record.value;
          }
        }
      });
    },
                                  ...
                                  [
                                    ...
                                    _c("editor", {
                                      ...
                                      model: {
                                        ...
                                        expression:
                                          "translations[language.id].contact_us",
                                      },
                                    }),
                                  ],
                                  1
