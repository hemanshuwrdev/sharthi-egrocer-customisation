...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getSlips: function getSlips() {
      var _this = this;
      var fromDate = this.dateRange.startDate && moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.startDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.startDate).format('YYYY-MM-DD') : undefined;
      var toDate = this.dateRange.endDate && moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.endDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.endDate).format('YYYY-MM-DD') : undefined;
      ...
      _c("div", { staticClass: "page-header-left" }, [
        ...
        _c("div", [
          _c("h1", { staticClass: "page-header-title" }, [
            _vm._v(_vm._s(_vm.__("loading_slips_and_dispatches"))),
          ]),
          _vm._v(" "),
          _c("p", { staticClass: "page-header-subtitle" }, [
            _vm._v(
              _vm._s(_vm.__("track_and_dispatch_warehouse_loading_slips"))
            ),
          ]),
        ]),
      ]),
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("option", { attrs: { value: "0" } }, [
                        _vm._v(_vm._s(_vm.__("planned"))),
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "1" } }, [
                        _vm._v(_vm._s(_vm.__("dispatched"))),
                      ]),
                      _vm._v(" "),
                  ...
                  [
                    ...
                    _c("b-form-input", {
                      attrs: {
                        id: "filter-input",
                        type: "search",
                        placeholder: _vm.__("search_by_slip_no_vehicle_driver"),
                      },
