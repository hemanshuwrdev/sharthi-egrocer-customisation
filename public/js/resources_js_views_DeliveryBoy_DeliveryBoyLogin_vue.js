...
/* harmony import */ var _firebasePhoneAuth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../firebasePhoneAuth */ "./resources/js/firebasePhoneAuth.js");
  ...
  methods: {
    sendOtp: function sendOtp() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, {
        ...
        if (data.data && data.data.otp_provider === 'firebase') {
          (0,_firebasePhoneAuth__WEBPACK_IMPORTED_MODULE_2__.sendFirebaseOtp)(_this.$apiUrl, 'delivery-boy-login-recaptcha', fullPhone).then(function (confirmationResult) {
            _this.isSendingOtp = false;
            _this.firebaseConfirmationResult = confirmationResult;
            _this.otpFirebase = true;
            _this.otpSent = true;
            _this.showMessage('success', "OTP sent successfully!");
          })["catch"](function (err) {
            _this.isSendingOtp = false;
            _this.showError(err.message || 'Failed to send OTP via Firebase.');
          });
        } else {
          _this.isSendingOtp = false;
          _this.otpFirebase = false;
          _this.otpSent = true;
          _this.showMessage('success', "OTP sent successfully!");
        }
    ...
    loginCheck: function loginCheck() {
      ...
      if (this.otpFirebase) {
        ...
        this.isLoading = true;
        (0,_firebasePhoneAuth__WEBPACK_IMPORTED_MODULE_2__.confirmFirebaseOtp)(this.firebaseConfirmationResult, this.user.otp).then(function () {
          return _this2.submitLogin();
        })["catch"](function () {
          _this2.isLoading = false;
          _this2.showError('Invalid OTP. Please check and try again.');
        });
        return;
      }
      this.submitLogin();
    ...
    submitLogin: function submitLogin() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(url, payload).then(function (res) {
        ...
        if (data.status === 1) {
          ...
          _this3.$router.push('/delivery_boy');
        } else {
        ...
        _c("div", { staticClass: "auth-section" }, [
          _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("div", { attrs: { id: "delivery-boy-login-recaptcha" } }),
              _vm._v(" "),
              _c(
                "router-link",
                {
