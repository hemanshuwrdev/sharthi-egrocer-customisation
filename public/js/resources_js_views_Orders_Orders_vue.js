  ...
  methods: {
    ...
    deleteOrderItem: function deleteOrderItem(index, id) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_3___default().post(_this5.$apiUrl + '/orders/delete_item', postData).then(function (response) {
    ...
    getAdditionalChargesTooltip: function getAdditionalChargesTooltip(charges) {
      ...
      return charges.map(function (charge) {
        return "".concat(charge.title, ": ").concat(_this6.$currency).concat(_this6.formatAmount(charge.amount));
      }).join('\n');
    },
            ...
            [
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("b-col", { staticClass: "mb-3", attrs: { md: "4" } }, [
                    _c(
                      "h6",
                      ...
                      [
                        ...
                        _vm._l(_vm.sellers, function (seller) {
                          return _c(
                            ...
                            [_vm._v(_vm._s(_vm.getDisplayName(seller.name)))]
                          )
                        }),
                      ],
                      2
                  ...
                  _c(
                    "b-col",
                    { staticClass: "text-center mb-3", attrs: { md: "1" } },
                    [
                      _c(
                        "button",
                        {
