...
/* harmony import */ var _mixins_DateRangePickerMixin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../mixins/DateRangePickerMixin */ "./resources/js/mixins/DateRangePickerMixin.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [_mixins_DateRangePickerMixin__WEBPACK_IMPORTED_MODULE_2__["default"]],
  components: {
  ...
  methods: {
    ...
    setQuickRange: function setQuickRange(key) {
      var ranges = {
    ...
    getLast7DaysRange: function getLast7DaysRange() {
      var end = new Date();
    ...
    load: function load() {
      var _this = this;
      this.loading = true;
      var fromDate = this.dateRange.startDate && moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dateRange.startDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dateRange.startDate).format('YYYY-MM-DD') : undefined;
      var toDate = this.dateRange.endDate && moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dateRange.endDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dateRange.endDate).format('YYYY-MM-DD') : undefined;
...
var render = function () {
  ...
  return _c("div", { staticClass: "list-page" }, [
    ...
    _c("div", { staticClass: "list-surface" }, [
        ...
        _c("div", { staticClass: "list-toolbar-start" }, [
          _c("div", { staticClass: "list-filter" }, [
            ...
            _c(
              "div",
              {
                staticClass: "btn-group btn-group-sm trip-type-toggle",
                attrs: { role: "group" },
              },
            ...
            _c(
              ...
              [
                ...
                _c("option", { attrs: { value: "open" } }, [
                  _vm._v(_vm._s(_vm.__("open"))),
                ]),
                _vm._v(" "),
                _c("option", { attrs: { value: "locked" } }, [
                  _vm._v(_vm._s(_vm.__("locked"))),
                ]),
                _vm._v(" "),
                _c("option", { attrs: { value: "reconciled" } }, [
                  _vm._v(_vm._s(_vm.__("reconciled"))),
                ]),
                _vm._v(" "),
                _c("option", { attrs: { value: "needs_rereconcile" } }, [
                  _vm._v(_vm._s(_vm.__("Needs Re-Reconcile"))),
                ]),
              ]
            ),
          ]),
          ...
          _c("div", { staticClass: "list-filter" }, [
            _c("span", { staticClass: "list-filter-label" }, [
              _vm._v(_vm._s(_vm.__("Date Range"))),
            ]),
            _vm._v(" "),
            _c(
              "div",
              ...
              [
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return _vm.setQuickRange("today")
                      },
                    },
                  },
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return _vm.setQuickRange("last7")
                      },
                    },
                  },
                  [_vm._v(_vm._s(_vm.__("Last 7 Days")))]
                ),
                _vm._v(" "),
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return _vm.setQuickRange("this_month")
                      },
                    },
                  },
                  [_vm._v(_vm._s(_vm.__("this_month")))]
                ),
              ],
              1
            ),
      ...
      _vm._v(" "),
      _vm.loading
        ? _c("div", { staticClass: "text-center py-5" }, [_c("b-spinner")], 1)
        : _vm.rows.length === 0
      ...
      _vm.total > _vm.perPage
        ? _c(
            ...
            [
              ...
              _vm._v(" "),
              _c("b-pagination", {
                staticClass: "list-pagination mb-0",
