          ...
          _vm.$roleSeller == _vm.login_user.role.name
            ? [
                _c("input", {
                  ...
                  attrs: { type: "hidden" },
                  domProps: { value: (_vm.seller = _vm.login_user.seller.id) },
                  on: {
                ...
                _c("b-col", { attrs: { md: "3" } }, [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm._v(" "),
                      _vm._l(_vm.translatedSellers, function (seller) {
                        return _c(
                          "option",
              ...
              },
              {
                ...
                fn: function (row) {
                  return [
                    ...
                    row.item.stock_unit
                      ? _c("span", [_vm._v(_vm._s(row.item.stock_unit))])
                      : _vm._e(),
                  ]
                },
              },
                ...
                fn: function (row) {
                  return [
                    row.item.is_unlimited_stock
                      ? _c("span", [_vm._v(_vm._s(_vm.__("unlimited")))])
                      : [
                          _vm._v(
                            "\n                                        " +
                  ...
                  return [
                    _vm.$can("product_update")
                      ? _c(
                          ...
                          [
                            row.item.status == 1
                              ? _c("span", { staticClass: "primary-toggal" }, [
                                  _c("i", {
