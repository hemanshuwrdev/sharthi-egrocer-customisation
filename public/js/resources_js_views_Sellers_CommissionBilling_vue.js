...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadBilling: function loadBilling() {
      var _this = this;
      ...
      _c("section", { staticClass: "section" }, [
        _vm.loading
              ...
              [
                ...
                _c(
                  ...
                  _vm._l(_vm.periodLabels, function (label, key) {
                    return _c("b-col", { key: key, attrs: { md: "4" } }, [
                      _c("div", { staticClass: "card border-0 shadow-sm" }, [
                        _c("div", { staticClass: "card-body text-center" }, [
                          ...
                          _c(
                            "div",
                            { staticClass: "h4 text-success fw-bold" },
                            [
                              _vm._v(
                                "\n                                    " +
                                  _vm._s(_vm.$currency) +
                                  " " +
                                  _vm._s(_vm.billing.gmv[key].toFixed(2)) +
                                  "\n                                "
                              ),
                            ]
                          ),
                          ...
                          _c(
                            "div",
                            { staticClass: "h5 text-primary fw-bold" },
                            [
                              _vm._v(
                                "\n                                    " +
                                  _vm._s(_vm.$currency) +
                                  " " +
                                  _vm._s(
                                    _vm.billing.commission_paid[key].toFixed(2)
                                  ) +
                                  "\n                                "
                              ),
                            ]
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "text-muted small" }, [
                            _vm._v(_vm._s(_vm.__("commission_paid"))),
                          ]),
                        ]),
                      ]),
                    ])
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _c("b-table", {
                            attrs: {
                              items: _vm.billing.transactions.data,
                              fields: _vm.txFields,
                              bordered: true,
                              "show-empty": "",
                              small: "",
                        ...
                        [
                            ...
                            _c("div", { staticClass: "text-primary h6" }, [
                              _vm._v(
                                "\n                                    " +
                                  ...
                                  " " +
                                  _vm._s(
                                    _vm.billing.commission_paid.all_time.toFixed(
                                      2
                                    )
                                  ) +
                                  "\n                                "
                          ...
                          _c(
                            ...
                            [
                              _c("b-pagination", {
                                attrs: {
                                  "total-rows": _vm.billing.transactions.total,
                                  "per-page": _vm.perPage,
                                  size: "sm",
                                },
                                on: { change: _vm.loadBilling },
                                model: {
                                  value: _vm.page,
                                  callback: function ($$v) {
                                    _vm.page = $$v
          ...
          : _c("div", { staticClass: "alert alert-info" }, [
              _vm._v(
                "\n                " +
                  _vm._s(_vm.__("no_billing_data_available")) +
                  "\n            "
              ),
            ]),
      ]),
