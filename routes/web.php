...
Route::post('api/clear_language_session', [\App\Http\Controllers\Controller::class, 'clearLanguageSession'])->name('clear_language_session');

Route::get('/js/lang', function () {

    $lang = config('app.locale');
    $lang = $lang ?? 'en';
    $file = Cache::rememberForever('lang.js.'.$lang, function () use($lang) {
