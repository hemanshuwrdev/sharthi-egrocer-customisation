...
<html>
    ...
    <body>
        <section class="invoice" id="printMe">
            <table width="100%">
                <tr>
                    <td width="50%" style="text-align: left; vertical-align: top;"><h2> <img src="{{ $logo_full_path }}" height="45"> {{ $appName }}</h2></td>
                    <td width="50%" style="text-align: right; vertical-align: top;"><h2>Retail Invoice</h2><h5 style="text-align: left;">
            </table>
            <br>
            <table width="100%">
                <tr>
                    ...
                    <td width="33.3" style="vertical-align: top;">
                        <div class="text-center">
                            ...
                            @endif
                            <address>
                                <strong>{{ implode(' / ', array_filter([$order->order_mobile ?? '', $order->alternate_mobile ?? ''])) }}</strong><br>
                            </address>
                            <address>
                    ...
                    <td width="33.3" style="vertical-align: top;">
                        <div class="text-right">
                            ...
                            <address>
                                <b>Date: </b>{{ $order->orders_created_at }}
                            </address>
                        </div>
                    </td>
                </tr>
