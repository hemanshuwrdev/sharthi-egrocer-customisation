            ...
            <div class="udaan-invoice">
                ...
                <div class="udaan-address-columns">
                    ...
                    <div
                        ...
                        <svg width="65" height="65" viewBox="0 0 29 29" fill="black"
                            style="border: 1px solid #ccc; padding: 3px; background: #fff;">
                            <path
                        ...
                        <span
                            style="font-size: 7px; color: #666; margin-top: 4px; font-weight: bold; text-align: center; width: 65px; letter-spacing: 0.5px;">SCAN
                            CODE</span>
                    </div>
                </div>
