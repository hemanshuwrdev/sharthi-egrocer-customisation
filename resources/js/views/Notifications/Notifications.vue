                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> {{ __('send_notification') }}
                                </li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card-header">
                        ...
                        <span class="pull-right">
                            <button class="btn btn-primary" @click="create_new = true"
                                v-if="$can('send_notification')">{{ __('send_notification') }}</button>
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <b-table :items="notifications" :fields="fields" :current-page="currentPage"
                                ...
                                <template #cell(actions)="row">
                                    <button class="btn btn-sm btn-danger"
                                        ...
                                        v-if="$can('notification_delete')" v-b-tooltip.hover :title="__('delete')"><i
