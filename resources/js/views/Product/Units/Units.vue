                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><router-link to="/manage_products">{{ __('product')
                                }}</router-link></li>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="pull-right">
                            <button class="btn btn-primary" @click="create_new = true" v-if="$can('units')">{{
                                __('add_unit') }}</button>
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <b-table :items="translatedUnits" :fields="fields" :current-page="currentPage"
                            ...
                            <template #cell(actions)="row">
                                ...
                                <button class="btn btn-sm btn-danger" @click="deleteUnit(row.index, row.item.id)"
