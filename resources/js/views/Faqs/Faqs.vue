    ...
    <div class="list-page">
        ...
        <div class="list-surface">
            ...
            <div class="table-responsive">
                <b-table :items="translatedFaqs" :fields="fields" :current-page="currentPage" :per-page="perPage"
                    ...
                    <template #cell(faqs)="row">
                        ...
                        <div class="faq-answer">
                            ...
                            <!-- View More/Less Link -->
                            <a v-if="shouldTruncate(row.item.answer)" @click="toggleFaqExpansion(row.item.id)"
                                href="javascript:void(0)" style="color: #007bff; font-size: 12px; cursor: pointer;">
                    ...
                    <template #cell(actions)="row">
                        <div class="list-actions">
                            <button class="list-action-btn is-edit" @click="edit_record = row.item" v-b-tooltip.hover
                                :title="__('edit')" v-if="$can('faq_update')"><i class="fa fa-pencil-alt"></i></button>
                            <button class="list-action-btn is-delete"
                                @click="deleteSocialMedia(row.index, row.item.id)" v-b-tooltip.hover
                                :title="__('delete')" v-if="$can('faq_delete')"><i class="fa fa-trash"></i></button>
                        </div>
                    </template>
                </b-table>
            </div>
