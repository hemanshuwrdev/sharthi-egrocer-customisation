                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(actions)="row"> 
                                    <button class="btn btn-sm btn-primary" @click="edit_record = row.item" v-b-tooltip.hover  v-if="$can('update_email_template')" :title="__('edit')" ><i class="fa fa-pencil-alt"></i></button>
