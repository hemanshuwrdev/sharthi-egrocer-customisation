    ...
    <div class="list-page">
        ...
        <div class="list-surface">
            <div class="list-toolbar">
                ...
                <button class="list-icon-btn" v-b-tooltip.hover :title="__('refresh')" @click="getEmailTemplates()">
                ...
                <b-table
                    ...
                    <template #cell(actions)="row">
                        <div class="list-actions">
                            <button class="list-action-btn is-edit" @click="edit_record = row.item" v-b-tooltip.hover  v-if="$can('update_email_template')" :title="__('edit')" ><i class="fa fa-pencil-alt"></i></button>
                            <button class="list-action-btn is-delete" @click="deleteEmailTemplate(row.index,row.item.id)" v-if="$can('delete_email_template')" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
                        </div>
                    </template>
                </b-table>
            </div>
