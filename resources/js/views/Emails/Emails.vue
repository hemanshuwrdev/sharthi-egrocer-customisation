                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="pull-right">
                            <button class="btn btn-primary"  @click="create_new=true" v-if="$can('send_email')">{{ __('send_email') }}</button>
                        </span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <b-table
                                ...
                                <template #cell(actions)="row">
                                    <button class="btn btn-sm btn-danger" @click="deleteEmail(row.index,row.item.id)"  v-if="$can('delete_send_email')" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
                                </template>
