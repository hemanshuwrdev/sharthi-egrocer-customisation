                ...
                <b-table
                    ...
                    <template #cell(actions)="row">
                        <div class="list-actions">
                            <button class="list-action-btn is-delete" @click="deleteEmail(row.index,row.item.id)"  v-if="$can('delete_send_email')" v-b-tooltip.hover :title="__('delete')"><i class="fa fa-trash"></i></button>
                        </div>
                    </template>
