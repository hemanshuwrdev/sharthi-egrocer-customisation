                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex align-items-center justify-content-between">
                            <button class="btn btn-danger me-3 mt-1" @click="confirmExit">
                                <i class="fas fa-arrow-left"></i> {{__('exit_pos')}}
                            </button>
                            <h5>{{__('pos_billing')}}</h5>
                            <h5>{{ storeName }}</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-between gap-2 flex-wrap">
                    <div class="flex-grow-1" style="min-width: 0; overflow: hidden;">
                        <div class="pos-tabs-wrapper d-flex">
                            ...
                            <button v-if="tabs.length < 5" class="btn btn-sm btn-outline-primary ms-2"
                                @click="addNewTab">
                                <i class="fas fa-plus"></i>{{__('hold_bill_and_create_another')}}
                            </button>
                        </div>
                    </div>
                    <div class="flex-shrink-0">
                        <button v-if="previousOrders.length > 0" class="btn"
                            ...
                            <i class="fas fa-receipt"></i> {{__('previous_bill')}}
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="d-flex flex-wrap gap-2 flex-grow-1 justify-content-end">
                                <!-- Category Filter -->
                                <div class="pos-filter-item">
                                    <select class="form-select" style="min-width: 160px;" v-model="selectedCategory"
                                        @change="getProducts">
                                ...
                                <!-- Search Input -->
                                <div class="pos-filter-item pos-search-input">
                                    <input type="text" class="form-control" v-model="searchTerm"
                                        :placeholder="__('products')" @input="debounceSearch">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div v-else class="row g-3">
                            <div v-for="product in products" :key="product.id" class="col-6 col-sm-4 col-md-4 col-lg-3">
                            ...
                            <div class="col-8">
                                <div class="search-select">
                                    <input type="text" class="form-control" v-model="customerSearchTerm"
                                        @input="searchCustomers" :placeholder="__('search_customer')" />
...
.pos-tabs-wrapper::-webkit-scrollbar {
    display: none;
    /* Chrome / Safari */
}
...
@media (max-width: 575.98px) {
    ...
    .pos-tabs-wrapper>.btn {
        font-size: 0;
        padding: 5px 10px;
        line-height: 1;
    }

    .pos-tabs-wrapper>.btn .fas {
        font-size: 0.9rem;
    }
}
