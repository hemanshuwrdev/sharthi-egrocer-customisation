                        ...
                        <b-row class="mb-2">
                            <b-col md="3">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <date-range-picker :single-date-picker="'range'" :autoApply=false :showDropdowns=true v-model="dateRange"
                                        :maxDate="maxDate" @update="getTransactions" opens="right"
                            ...
                            <b-col md="3">
                                ...
                                <select name="delivery_boy" id="delivery_boy" v-model="deliveryBoy"
                                    @change="getTransactions()" class="form-control form-select">
                        ...
                        <div class="table-responsive">
                            <b-table :items="transactions" :fields="fields" :current-page="currentPage"
                                ...
                                <template #cell(amount)="row">
                                    <span
                                        v-if="row.item.type === 'Delivery Boy Cash Collection'">{{ row.item.collected_amount }}</span>
