                ...
                <form id="contact_us_form" method="post" enctype="multipart/form-data" @submit.prevent="saveRecord">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> {{ __('seller_privacy_policy_terms_conditions') }}</h4>
                        </div>
                        <div class="card-body">
                            <!-- Language Tabs -->
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <a :href="$baseUrl+'/seller-privacy-policy?lang=' + language.code" v-b-tooltip.hover :title="__('privacy_policy')" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                </div>
                                <editor
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between mb-2">
                                                <label> {{ __('terms_conditions') }} <i class="text-danger" v-if="language.is_default">*</i></label>
                                                <a :href="$baseUrl+'/seller-terms-conditions?lang=' + language.code" v-b-tooltip.hover :title="__('terms_conditions')" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                </div>
                                <editor
